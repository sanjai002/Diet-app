# Generated by Django 4.1 on 2023-11-21 06:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies', models.CharField(max_length=80)),
        ...
        migrations.AddField(
            model_name='food',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food_category', to='diet.foodcategory'),
        ),
    ]
